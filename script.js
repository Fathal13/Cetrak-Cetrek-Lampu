function saklar() {
    ...
    let toggleMandi = document.getElementById("toggle-mandi");
    let toggleKamar = document.getElementById("toggle-kamar");
    ...
    if(toggleMakan.checked) {
        lampu1.src = "assets/gambar/on.gif";
        lampu2.src = "assets/gambar/on.gif";
        lampu3.src = "assets/gambar/on.gif";
    } else {
        if(toggle1.checked) {
            lampu1.src = "assets/gambar/on.gif"
        } else{
            lampu1.src = "assets/gambar/off.gif"
        }
        if(toggle2.checked) {
            lampu2.src = "assets/gambar/on.gif"
        } else {
            lampu2.src = "assets/gambar/off.gif"
        }
        if(toggle3.checked) {
            lampu3.src = "assets/gambar/on.gif"
        } else {
            lampu3.src = "assets/gambar/off.gif"
        }
    }

    if(toggleMandi.checked) {
        lampu4.src = "assets/gambar/on.gif"
    } else {
        if (toggle4.checked) {
            lampu4.src = "assets/gambar/on.gif"
        } else {
            lampu4.src = "assets/gambar/off.gif"
        }
    }
    
    if(toggleKamar.checked) {
        lampu5.src = "assets/gambar/on.gif";
        lampu6.src = "assets/gambar/on.gif";
    } else {
        if(toggle5.checked) {
            lampu5.src = "assets/gambar/on.gif"
        } else{
            lampu5.src = "assets/gambar/off.gif"
        }
        if(toggle6.checked) {
            lampu6.src = "assets/gambar/on.gif"
        } else {
            lampu6.src = "assets/gambar/off.gif"
        }
    }

    if(toggleKeluarga.checked) {
        lampu7.src = "assets/gambar/on.gif";
        lampu8.src = "assets/gambar/on.gif";
        lampu9.src = "assets/gambar/on.gif";
        lampu10.src = "assets/gambar/on.gif";
    } else {
        if(toggle7.checked) {
            lampu7.src = "assets/gambar/on.gif"
        } else{
            lampu7.src = "assets/gambar/off.gif"
        }
        if(toggle8.checked) {
            lampu8.src = "assets/gambar/on.gif"
        } else {
            lampu8.src = "assets/gambar/off.gif"
        }
        if(toggle9.checked) {
            lampu9.src = "assets/gambar/on.gif"
        } else {
            lampu9.src = "assets/gambar/off.gif"
        }
        if(toggle10.checked) {
            lampu10.src = "assets/gambar/on.gif"
        } else {
            lampu10.src = "assets/gambar/off.gif"
        }
    }
} 